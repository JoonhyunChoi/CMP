...
public PlaceView() {
      ...
      p6.add(new Label("상영관 선택"));
      p6.add(new Label("                                                "));
      p6.setFont(new Font(Font.DIALOG, Font.PLAIN, 15));
	  p6.setSize(810, 100);
      p6.setLocation(20, 200);
